...
fs.writeFileSync(path.join(gameName, 'src', 'admin-client.html'), adminClientHtmlFile)
fs.writeFileSync(path.join(gameName, 'src', 'admin-client.css'), adminClientCssFile)
...
fs.writeFileSync(path.join(gameName, 'src', 'stages', 'stage1', 'stage1.html'), stage1HtmlFile)
fs.writeFileSync(path.join(gameName, 'src', 'stages', 'stage1', 'stage1.css'), stage1CssFile)
